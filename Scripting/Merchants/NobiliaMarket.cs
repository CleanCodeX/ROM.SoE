...
using ROM.SoE.Scripting.Bases;

// ReSharper disable InconsistentNaming

namespace ROM.SoE.Scripting.Merchants
{
	/// <summary>
	/// Relevant code routines of Nobilia market merchants starting at script address offset around [0x968736]
	///  </summary>
	internal class NobiliaMarket : ScriptingBase
	{
		internal UInt16 _2262_Charms;
		internal UInt16 _228b_TalkedToPersons;
		internal UInt16 _2527_OwnedRice; // Amount of owned Rice
		internal UInt16 _243d_UnknownStatusMaybe;
		internal UInt16 _251b_OwnedPots; // Previously owned pots
		internal UInt16 _285d_Unknown; // What does it do? 
		internal UInt16 _Jewels;
